...
function placeOrder(formObject) {
  var stripe = Stripe('pk_test_51KFeu3SCatt0pJofslV3eAf0fZE4kKqbOeparrX6Wx5dA5gTUyQkc5hLRWTtnYAvrh3j6f92vt7JzvxDOubRjM0T00Dt6LMwph'); // console.log(formObject);
...
var adminAreaPath = document.location.pathname;
    ...
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            stripe = Stripe('pk_test_51KFeu3SCatt0pJofslV3eAf0fZE4kKqbOeparrX6Wx5dA5gTUyQkc5hLRWTtnYAvrh3j6f92vt7JzvxDOubRjM0T00Dt6LMwph'); //    const stripe = await loadStripe('pk_test_51KFeu3SCatt0pJofslV3eAf0fZE4kKqbOeparrX6Wx5dA5gTUyQkc5hLRWTtnYAvrh3j6f92vt7JzvxDOubRjM0T00Dt6LMwph');
                    ...
                    while (1) {
                      switch (_context.prev = _context.next) {
                        case 0:
                          ...
                          // Ajax
                          axios__WEBPACK_IMPORTED_MODULE_3___default().post('/orders', formObject).then(function (res) {
                            new (noty__WEBPACK_IMPORTED_MODULE_4___default())({
                              type: 'success',
                              timeout: 1000,
                              text: "success",
                              progressBar: false
                        ...
                        case 8:
                          axios__WEBPACK_IMPORTED_MODULE_3___default().post('/orders', formObject).then(function (session) {
                            return stripe.redirectToCheckout({
